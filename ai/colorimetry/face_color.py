...
REGION_LANDMARKS = {
    ...
    "left_under_eye": (145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159),
    "right_under_eye": (374, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389),
    # ── NEW: Perioral (mouth corner) regions ──
    "left_perioral": (61, 62, 63, 64, 65, 66, 67, 68, 69, 70),
    "right_perioral": (291, 292, 293, 294, 295, 296, 297, 298, 299, 300),
}
